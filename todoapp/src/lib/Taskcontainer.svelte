<script>
  ...
  let validate = false
    ...
    <div class="col-span-6 w-full max-h-72 h-full flex flex-col bg-[#5C8374] rounded-3xl justify-between duration-200" class:opacity-75={validate} key={task.id}>
      <div class="bg-[#183D3D] h-full px-10 py-5 rounded-3xl">
        <h2>{task.name}</h2>
